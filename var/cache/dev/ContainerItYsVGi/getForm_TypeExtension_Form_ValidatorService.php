...
class getForm_TypeExtension_Form_ValidatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->privates['debug.validator'] ?? $container->getDebug_ValidatorService());

        if (isset($container->privates['form.type_extension.form.validator'])) {
            return $container->privates['form.type_extension.form.validator'];
        }

        return $container->privates['form.type_extension.form.validator'] = new \Symfony\Component\Form\Extension\Validator\Type\FormTypeValidatorExtension($b, false, $a, ($container->services['translator'] ?? $container->getTranslatorService()));
    }
}
