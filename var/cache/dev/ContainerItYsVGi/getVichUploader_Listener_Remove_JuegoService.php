 ...
 */
class getVichUploader_Listener_Remove_JuegoService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.juego' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.juego'])) {
            return $container->privates['vich_uploader.listener.remove.juego'];
        }

        return $container->privates['vich_uploader.listener.remove.juego'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('juego', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
