 ...
 */
class Invitacion extends \App\Entity\Invitacion implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'asistencia' => [parent::class, 'asistencia', null],
        "\0".parent::class."\0".'eventos' => [parent::class, 'eventos', null],
        "\0".parent::class."\0".'id' => [parent::class, 'id', null],
        "\0".parent::class."\0".'nombre' => [parent::class, 'nombre', null],
        "\0".parent::class."\0".'users' => [parent::class, 'users', null],
        'asistencia' => [parent::class, 'asistencia', null],
        'eventos' => [parent::class, 'eventos', null],
