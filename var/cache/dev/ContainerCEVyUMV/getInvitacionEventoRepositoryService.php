 ...
 */
class getInvitacionEventoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InvitacionEventoRepository' shared autowired service.
     *
     * @return \App\Repository\InvitacionEventoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InvitacionEventoRepository.php';

        return $container->privates['App\\Repository\\InvitacionEventoRepository'] = new \App\Repository\InvitacionEventoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
