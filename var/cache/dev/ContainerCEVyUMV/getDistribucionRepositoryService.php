 ...
 */
class getDistribucionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DistribucionRepository' shared autowired service.
     *
     * @return \App\Repository\DistribucionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DistribucionRepository.php';

        return $container->privates['App\\Repository\\DistribucionRepository'] = new \App\Repository\DistribucionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
