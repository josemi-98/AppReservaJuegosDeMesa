 ...
 */
class getDistribucion2RepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Distribucion2Repository' shared autowired service.
     *
     * @return \App\Repository\Distribucion2Repository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Distribucion2Repository.php';

        return $container->privates['App\\Repository\\Distribucion2Repository'] = new \App\Repository\Distribucion2Repository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
