 ...
 */
class getVichUploader_Listener_Upload_JuegoService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.juego' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.juego'])) {
            return $container->privates['vich_uploader.listener.upload.juego'];
        }

        return $container->privates['vich_uploader.listener.upload.juego'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('juego', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
