...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureDashboard(): Dashboard
    {
        return Dashboard::new()
            ->setTitle('Bienvenido a la aministracion de juegos');
            // ->setLocales([
    ...
    public function configureMenuItems(): iterable
    {
       ...
       // yield MenuItem::linkToCrud('The Label', 'fas fa-list', EntityClass::class);
        ...
        yield MenuItem::linkToCrud('Reservas', 'fa fa-tags', Reservas::class);
        yield MenuItem::linkToCrud('Eventos', 'fa fa-tags', Eventos::class);
        yield MenuItem::linkToCrud('User', 'fa fa-tags', User::class);
        yield MenuItem::linkToCrud('Invitacion', 'fa fa-tags', Invitacion::class);
